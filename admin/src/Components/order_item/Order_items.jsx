...
import { ArrowLeft, ClipboardList, Clock, Truck, CheckCircle, XCircle, MapPin, Phone, Mail, Package, User, CreditCard } from "lucide-react";
    ...
    <div className="order-items-page">
      <div className="order-items-header">
        <div>
          ...
          <p>Hiển thị toàn bộ dữ liệu từ bảng `order_items` theo từng đơn</p>
        </div>
        ...
        <div className="order-items-toolbar">
          <div className="search-box">
            <input
              ...
              placeholder="Tìm theo tên khách, sản phẩm, số điện thoại..."
            />
          </div>
        </div>
      )}
